...
const FIRMS = [
  {
    ...
    pricingNote: 'Current account pricing varies by plan; use the tracked link and try code DUTRADING',
  ...
  },
  {
    ...
    pricingNote: 'Current site offer: 25% off Premium plans with code PREMIUM; affiliate link tracks Duckens026406',
    platforms: ['TODO_VERIFY'],
  ...
  },
  {
    ...
    pricingNote: 'Available promotion is applied by the tracked link with code TNTIQNUL; verify the displayed checkout price',
    platforms: ['TODO_VERIFY'],
  ...
  },
  {
    ...
    pricingNote: 'Current site offer: 80% off Apprentice and 45% off Elite with code LTG; affiliate link tracks dutrading',
    platforms: ['TODO_VERIFY'],
