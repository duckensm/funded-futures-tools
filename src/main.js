...
function isRecommended(f){ return ['lucidtraderfunding','bulenox'].includes(f.id); }
...
function affiliateCard(f){
  if(isRecommended(f)){
    return `<div class="article-card affiliate-card"><h2>Recommended partner offer</h2><p>${recommendationBadge(f)} ${couponText(f)}</p><p>Lucid Trading and Bulenox are the current recommended partner offers on this site. Recheck live checkout prices and discount terms before buying.</p>${affiliateActions(f,false)}</div>`;
  }
...
function renderPhidiasArticle(f){
  ...
  <div class="article-card verify-card"><h2>Verification status</h2><p><span class="pill ${verificationClass(f)}">${verificationLabel(f)}</span></p><p>Official sources checked: <a href="https://phidiaspropfirm.com/phidias-2-0" target="_blank" rel="noreferrer">Phidias 2.0 launch</a>, <a href="https://phidiaspropfirm.com/accounts" target="_blank" rel="noreferrer">accounts</a>, <a href="https://phidiaspropfirm.com/rules" target="_blank" rel="noreferrer">rules</a>, and <a href="https://phidiaspropfirm.com/affiliate-program" target="_blank" rel="noreferrer">affiliate program</a>.</p><p class="disclaimer">Official Phidias pages were captured on 2026-06-01. Visible promo/coupon language and checkout pricing can change, so recheck checkout before sending paid traffic.</p></div>
  ${affiliateCard(f)}
