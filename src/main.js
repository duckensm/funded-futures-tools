...
function affiliateCard(f){
  ...
  if(f.affiliateUrl){
    return `<div class="article-card affiliate-card"><h2>Partner offer</h2><p>${couponText(f)}</p><p>Use this partner link if you choose ${f.name}, then confirm current prices, rules, promos, and account availability before buying.</p>${affiliateActions(f,false)}</div>`;
  }
...
function renderHome(){
  ...
  <section class="hero"><div class="wrap hero-grid">
    <div>
      ...
      <div class="mini-proof"><span><b>11</b> starter firms</span><span><b>3</b> calculators</span><span><b>NQ-first</b> examples</span><span><b>Partner offers</b> clearly labeled</span></div>
    </div>
