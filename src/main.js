...
const firms = [
  {id:'apex', name:'Apex Trader Funding', category:'Best high-search Apex/EOD option', best:'High search demand + EOD option', price:'EOD: $177-$397 retail', target:'$1.5k-$9k EOD', drawdown:'EOD trailing + intraday trailing', daily:'EOD DLL: $500-$2k', payout:'6-step payout ladder', risk:'Medium', officialUrl:'https://apextraderfunding.com/', lastVerified:'Needs official re-check', verification:'research-snapshot', fit:'Best for NQ traders who want a heavily searched futures prop firm and prefer EOD drawdown over intraday trailing.'},
  {id:'myfundedfutures', name:'MyFundedFutures', category:'Best modern futures-specific candidate', best:'Popular modern futures option', price:'Needs official verification', target:'Needs official verification', drawdown:'Needs official verification', daily:'Needs official verification', payout:'Needs official verification', risk:'Medium', officialUrl:'https://myfundedfutures.com/', lastVerified:'Not yet verified', verification:'unverified', fit:'Best for traders comparing newer futures-specific alternatives with strong current market interest.'},
  {id:'takeprofittrader', name:'TakeProfitTrader', category:'Best simple payout-message candidate', best:'Fast payout focus', price:'Needs official verification', target:'Needs official verification', drawdown:'Needs official verification', daily:'Needs official verification', payout:'Needs official verification', risk:'Medium', officialUrl:'https://takeprofittrader.com/', lastVerified:'Not yet verified', verification:'unverified', fit:'Best for traders who value simple branding and direct payout messaging.'},
...
function renderApexArticle(f){
  ...
  <div class="article-card verify-card"><h2>Verification status</h2><p><span class="pill ${verificationClass(f)}">${verificationLabel(f)}</span></p><p>Official source to manually check: <a href="${f.officialUrl}" target="_blank" rel="noreferrer">${f.officialUrl}</a></p><p class="disclaimer">Apex has useful research notes here, but the page should still receive an official manual re-check before paid traffic or affiliate promotion.</p></div>
